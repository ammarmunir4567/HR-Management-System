  ...
  return (
    <>
      <header className="flex items-center h-20 px-6 sm:px-10 bg-white">
        <button onClick={toggleDropdown} className="block sm:hidden relative flex-shrink-0 p-2 mr-2 text-gray-600 hover:bg-gray-100 hover:text-gray-800 focus:bg-gray-100 focus:text-gray-800 rounded-full">
          ...
          <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
            ...
            {auth.name && auth.role && (
              <>
                ...
                <span className="text-sm text-gray-600">{auth.role}</span>
              </>
            )}
